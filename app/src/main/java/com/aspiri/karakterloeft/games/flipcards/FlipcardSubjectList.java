...
//        setUpToolbar((Toolbar) findViewById(R.id.flipcard_toolbar));
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        switch (item.getItemId()) {
            ...
            case R.id.create_card:
                ...
                View cView = getLayoutInflater().inflate(R.layout.dialog_flipcard_creation, null);
                EditText cCategory = cView.findViewById(R.id.card_category);
                EditText cQuestionFront = cView.findViewById(R.id.card_question_front);
                EditText cShortAnswerBack = cView.findViewById(R.id.card_shortAnswer_back);
                EditText cLongAnswerBack = cView.findViewById(R.id.card_longAnswer_back);
                Button cAcknowledgeCardCreation = cView.findViewById(R.id.card_creation_acknowledge);
...
//    }
    ...
    private void loadFlipcards() {
        ...
        MultiSelectBuilder<Flipcard> builder = new MultiSelectBuilder<>(Flipcard.class)
                ...
                .withSidebarWidth(100 + 8 * 2); // ImageView width with paddings
